...
/** Shell compartido por login / registro / verificación 2FA — logo + card centrada sobre fondo con glow dorado sutil. */
  ...
  return (
    <main
      ...
      style={{
        minHeight: "100svh",
        background:
          "radial-gradient(60% 50% at 50% 0%, rgba(201,162,39,0.12), transparent 70%), var(--sanken-black)",
      }}
    >
